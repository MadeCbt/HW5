 ...
 ********************************************************************/
  ...
  * an element as 'present' - e.g., the more hash codes per item - the lower the 
  ...
  * available online to determine how to adjust the variables in order to 
 ...
 class BloomFilter {
      ...
      *
      * @param String - the value to add to the set
      */
      ...
      *
      * @param String - the value to check for membership
      */
